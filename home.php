...
<body>
    <div class="banner">
        ...
        <div class="content">
            ...
            <div>
            <button type="button" onclick="window.open('https://linktr.xee/Binder_softeng', '_blank')"><span></span>Hotline Service</button>
        ...
        <iframe src="https://www.youtube.com/embed/lrt8R-kXieE" frameborder="0" allowfullscreen></iframe>
         </div>
    </div>
            </div>
        </div>
